...
interface SonyflakeGenerateCustomIdOptions {
    timestamp: number;
    sequence: number;
}
interface SonyflakeDecomposeOptions {
    epoch: number;
}
interface DecomposedSonyflake {
    timestamp: number;
    machineId: number;
    sequence: number;
}
...
export { DecomposedSonyflake, Epoch, Snowflake, Sonyflake, SonyflakeDecomposeOptions, SonyflakeGenerateCustomIdOptions, SonyflakeOptions, Sonyflake as default };
